...
public class FeishuChannel extends AbstractChannel {
    ...
    public void send(AlarmDTO alarmDTO) {
        try {
            ...
            String title = this.resourceBundleMessageSource.getMessage(alarmDTO
                    .getEvent()
                    .getName(), null, locale);
            ...
            this.doSend(alarmDTO
                    ...
                    .getSecret(), alarmDTO
                    .getAlertRule()
                    .getUrl(), title, this.getHeaderColor(alarmDTO
                    .getEvent()
                    .getName()), content);
        } catch (Throwable e) {
    ...
    private void doSend(String secret, String url, String headerTile, String headerColor, String content) throws IOException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        // Header
        FeishuRequest.CardHeaderRequest header = feishuRequest
                .getCard()
                .getHeader();
        header.setTemplate(headerColor);
        header
                .getTitle()
                .setContent(headerTile);
    ...
    private String getHeaderColor(String eventName) {
        return Optional
                .ofNullable(COLOR_MAP.get(eventName))
                .orElse("red");
    }
}
