...
public class DelaySlotUtil {
    ...
    public static List<Long> getCurrentZsetSlots() {
        int maxSlot = ClusterContext
                .getSystem()
                .getMaxSlot();
        int delayZsetMaxSlot = ClusterContext
                .getSystem()
                .getDelayZsetSlot();
    ...
    public static List<Long> getFailCurrentZsetSlots() {
        int maxSlot = ClusterContext
                .getSystem()
                .getMaxSlot();
        int delayFailZsetMaxSlot = ClusterContext
                .getSystem()
                .getDelayFailZsetSlot();
    ...
    public static List<Long> getCurrentAddListSlots() {
        int maxSlot = ClusterContext
                .getSystem()
                .getMaxSlot();
        int delayListMaxSlot = ClusterContext
                .getSystem()
                .getDelayAddListSlot();
    ...
    public static List<Long> getCurrentStatusListSlots() {
        int maxSlot = ClusterContext
                .getSystem()
                .getMaxSlot();
        int delayStatusMaxSlot = ClusterContext
                .getSystem()
                .getDelayStatusListSlot();
    ...
    public static List<Long> getCurrentDeleteListSlots() {
        int maxSlot = ClusterContext
                .getSystem()
                .getMaxSlot();
        int delayDeleteMaxSlot = ClusterContext
                .getSystem()
                .getDelayDeleteListSlot();
