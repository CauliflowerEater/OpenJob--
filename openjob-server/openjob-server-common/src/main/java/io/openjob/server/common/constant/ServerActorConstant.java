...
public class ServerActorConstant {
    ...
    public static final String BEAN_ACTOR_WORKER_DELAY_INSTANCE_STATUS = "workerDelayInstanceStatusActor";
    ...
    public static final String DISPATCHER_WORKER_DELAY_INSTANCE_STATUS = "akka.actor.worker-delay-instance-status-dispatcher";
